...
useEffect(() => {
  ...
  return (
    <div className="flex flex-col items-center justify-center my-16  p-4 text-center ml-32">
      ...
      <p className="max-w-[600px] text-lg mt-2 text-gray-600 dark:text-gray-300 mb-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8 w-full max-w-3xl">
        <div className="flex flex-col items-center p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">Set up event details</p>
        </div>
        <div className="flex flex-col items-center p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md">
          <Users className="w-8 h-8 mb-2 text-blue-500" />
          <h3 className="text-lg font-semibold mb-1">Add Participants</h3>
          <p className="text-sm text-gray-600 dark:text-gray-400">Enter participant info</p>
        </div>
        <div className="flex flex-col items-center p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md">
          <CheckCircle className="w-8 h-8 mb-2 text-blue-500" />
          <h3 className="text-lg font-semibold mb-1">Issue & Validate</h3>
          <p className="text-sm text-gray-600 dark:text-gray-400">Generate & verify certificates</p>
        </div>
      </div>
    </div>
  )
