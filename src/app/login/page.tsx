    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="flex py-48 items-center gap-6 flex-col text-center">
                ...
                {user && !account ? <h1 className="text-3xl font-bold">Click Here to 👉<button onClick={connect} className="bg-white text-black hover:scale-110 transition-transform delay-75  hover:bg-customGreen px-2">Connect Wallet</button><br />Start using </h1> : <h1 className="text-3xl font-bold">Click Here to 👉<button onClick={signInWithGooglePopup} className="bg-white text-black hover:scale-110 transition-transform delay-75  hover:bg-customGreen px-2">Login </button><br /> and <button onClick={connect} className="bg-white text-black hover:scale-110 transition-transform delay-75  hover:bg-customGreen px-2">Connect Wallet</button><br />Start using </h1>}
            </div>
        </div>
    )
}
